  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close>
        <X className="h-10 w-10 absolute right-4 top-4 rounded-sm opacity-90 text-blueDark transition-opacity hover:opacity-100  disabled:pointer-events-none data-[state=open]:bg-secondary" />
