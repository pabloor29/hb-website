...
function ObjectifLineConception() {
  return (
    ...
    <div className="flex flex-col justify-center items-center mb-20">
      <div className="">
        <p className="md:text-2xl text-xl text-center font-Calibri">
      ...
      <div className="mb-20 text-center md:w-1/2 w-full pt-8">
        <a href="/me-contacter?tab=Tableau%20de%20Visualisation#formulaire" className='w-full'>
          <button className="mt-4 w-2/3 h-14 font-Calibri text-xl bg-blueDark/80 text-white px-4 rounded-xl border-b-4 border-blueDark hover:bg-blueDark">
